using JuMP
using Ipopt
function multioptimization1(Number1,Number2,Number3)
    # w1 = 0.01
    # Number1 = 2
    # Number2 = 2
    # Number3 = 2
    ...
    @NLconstraint(gp, (hed[1]*ZMui*Q*101.325*8000/(950*293.15*Rm*xiaolv[1]/100*rspeed1*1000) +
    hed[2]*ZMui*Q*101.325*8626.75/(950*293.15*Rm*xiaolv[2]/100*rspeed2*1000) +
    hed[3]*ZMui*Q*101.325*8626.75/(950*293.15*Rm*xiaolv[3]/100*rspeed3*1000)) - power == 0)
    ...
    if Number1 > 0
        ...
        @NLconstraint(gp,(-1423.7*((Q*101325*Z[1]*T[1]*T_0/(P[1]*1000)/293.15)*8000/rspeed1)^2+ 4713*Number1*((Q*101325*Z[1]*T[1]*T_0/(P[1]*1000)/293.15))*8000/rspeed1 + Number1^2*6635.9)*(rspeed1/8000)^2-Number1^2*hed[1]==0)
    ...
    if Number2 > 0
        ...
        @NLconstraint(gp,(-275.89*Number2*((Q*101325*Z[18]*T[18]*T_0/(P[18]*1000)/293.15)*8626.75/rspeed2)^2+ 1400.3*Number2^2*((Q*101325*Z[18]*T[18]*T_0/(P[18]*1000)/293.15))*8626.75/rspeed2 + Number2^3*4602.9)*(rspeed2/8626.75)^2-Number2^3*hed[2]==0)
    ...
    if Number3 > 0
        ...
        @NLconstraint(gp,(-275.89*Number3*((Q*101325*Z[35]*T[35]*T_0/(P[35]*1000)/293.15)*8626.75/rspeed3)^2+ 1400.3*Number3^2*((Q*101325*Z[35]*T[35]*T_0/(P[35]*1000)/293.15))*8626.75/rspeed3 + Number3^3*4602.9)*(rspeed3/8626.75)^2-Number3^3*hed[3]==0)
